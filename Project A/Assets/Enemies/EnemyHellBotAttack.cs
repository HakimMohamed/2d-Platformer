...
public class EnemyHellBotAttack : MonoBehaviour
{
    [Header("Attack")]
    ...
    public void Attack()
    {
        ...
        Collider2D[] hitEnemies2 = Physics2D.OverlapCircleAll(AttackPoint2.position, AttackRadius, playerLayer);
        Collider2D[] hitEnemies3 = Physics2D.OverlapCircleAll(AttackPoint3.position, AttackRadius, playerLayer);
        ...
        foreach (Collider2D Player in hitEnemies2)
        {
            var player_health = Player.GetComponent<PlayerHealth>();
        ...
        foreach (Collider2D Player in hitEnemies3)
        {
            var player_health = Player.GetComponent<PlayerHealth>();
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireSphere(AttackPoint2.position, AttackRadius);
        Gizmos.DrawWireSphere(AttackPoint3.position, AttackRadius);
